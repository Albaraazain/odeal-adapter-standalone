...
echo "   # Ödeal employeeInfo (minimum required: ODEAL_EMPLOYEE_REF)"
echo "   ODEAL_EMPLOYEE_REF=EMP001"
echo "   ODEAL_EMPLOYEE_NAME=Ahmet"
echo "   ODEAL_EMPLOYEE_SURNAME=Yilmaz"
echo "   ODEAL_EMPLOYEE_GSM_NUMBER=905551112233"
echo "   ODEAL_EMPLOYEE_IDENTITY_NUMBER=12345678901"
echo "   ODEAL_EMPLOYEE_MAIL_ADDRESS=ahmet.yilmaz@example.com"
echo "   ODEAL_REQUIRE_EMPLOYEE=true"
echo ""
