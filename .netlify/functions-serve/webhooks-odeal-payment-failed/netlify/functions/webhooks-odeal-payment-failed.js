...
// netlify/functions/webhooks-odeal-payment-failed.js
var webhooks_odeal_payment_failed_exports = {};
__export(webhooks_odeal_payment_failed_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(webhooks_odeal_payment_failed_exports);
...
async function handler(event, context) {
  ...
  try {
    ...
    await handleWebhook("payment-failed", req, res);
    return {
      statusCode: res.statusCode,
      headers: res.headers,
      body: res.body
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=webhooks-odeal-payment-failed.js.map
