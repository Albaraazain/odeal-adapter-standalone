...
// netlify/functions/app2app-baskets.js
var app2app_baskets_exports = {};
__export(app2app_baskets_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(app2app_baskets_exports);
...
async function getCheckDetail({ CheckId, CheckNo = 0, TableNo = "" }) {
  ...
  const url2 = `${ROP_BASE_URL}/CheckDetail`;
  const { data } = await http2.get(url2, { params });
  return data;
}
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=app2app-baskets.js.map
